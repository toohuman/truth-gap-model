...
def error(agent_type, belief, true_state, normalised = True):
    """
    Named after the error function in machine learning, this function calculates
    ...
    or "zero error" between the true value and the agents' belief.
...
def write_to_file(directory, file_name, params, data, max, array_data = False):
    ...
    while reusing the same function for writing single value averages, e.g., error.
    """
